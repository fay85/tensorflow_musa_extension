...
# tf_2.15.1_pluggable branch: TF 2.15.1 only. Override with comma-separated list if needed.
# Example: TENSORFLOW_MUSA_TARGET_TF=2.15.1 ./build.sh
TARGET_TF_VERSIONS="${TENSORFLOW_MUSA_TARGET_TF:-2.15.1}"
